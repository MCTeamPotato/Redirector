...
public abstract class MixinVec3i {
    ...
    public Vec3i north(int pDistance) {
        return this.relative(Redirectionor.NORTH, pDistance);
    }
    ...
    public Vec3i south(int pDistance) {
        return this.relative(Redirectionor.SOUTH, pDistance);
    }
    ...
    public Vec3i west(int pDistance) {
        return this.relative(Redirectionor.WEST, pDistance);
    }
    ...
    public Vec3i east(int pDistance) {
        return this.relative(Redirectionor.EAST, pDistance);
    }
