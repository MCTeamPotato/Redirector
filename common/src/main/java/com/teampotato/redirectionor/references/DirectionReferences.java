...
public class DirectionReferences {
    ...
    public static class AxisReferences {
    ...
    public static class OrdinalReferences {
    ...
    public static class DataValueReferences {
    ...
    public static class AxisDirectionReferences {
