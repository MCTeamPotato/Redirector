...
public abstract class MixinBlendingData {
    ...
    private void calculateData(ChunkAccess p_190318_, Set<Direction8> p_190319_) {
        if (!this.hasCalculatedData) {
            if (p_190319_.contains(Redirectionor._8_NORTH) || p_190319_.contains(Redirectionor._8_WEST) || p_190319_.contains(Redirectionor.NORTH_WEST)) {
            ...
            if (p_190319_.contains(Redirectionor._8_EAST) && p_190319_.contains(Redirectionor.NORTH_EAST)) {
                this.addValuesForColumn(getOutsideIndex(CELL_HORIZONTAL_MAX_INDEX_OUTSIDE, 0), p_190318_, 15, 0);
            }

            if (p_190319_.contains(Redirectionor._8_EAST) && p_190319_.contains(Redirectionor._8_SOUTH) && p_190319_.contains(Redirectionor.SOUTH_EAST)) {
