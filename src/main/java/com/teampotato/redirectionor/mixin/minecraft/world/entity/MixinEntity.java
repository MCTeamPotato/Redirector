...
public abstract class MixinEntity {
    ...
    @Unique private static final Direction[] DIRECTIONS = new Direction[]{Redirectionor.NORTH, Redirectionor.SOUTH, Redirectionor.WEST, Redirectionor.EAST, Redirectionor.UP};
