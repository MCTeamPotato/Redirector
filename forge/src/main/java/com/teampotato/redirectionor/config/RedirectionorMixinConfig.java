...
public class RedirectionorMixinConfig {
    ...
    public RedirectionorMixinConfig() {
        ...
        this.addMixinRule("compat.lithium", isNotLoaded("lithium") && isNotLoaded("canary") && isNotLoaded("radium") && isNotLoaded("roadrunner"));
        this.addMixinRule("compat.modernfix", isNotLoaded("modernfix"));
        this.addMixinRule("compat.nicerportals", isNotLoaded("nicerportals"));
        this.addMixinRule("compat.sodium", isNotLoaded("sodium") && isNotLoaded("magnesium") && isNotLoaded("rubidium") && isNotLoaded("chlorine"));
