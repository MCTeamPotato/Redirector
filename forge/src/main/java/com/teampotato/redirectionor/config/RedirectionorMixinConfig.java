...
public class RedirectionorMixinConfig {
    ...
    public RedirectionorMixinConfig() {
        ...
        this.addMixinRule("net.minecraftforge.client.model.pipeline", true);
        ...
        this.addMixinRule("net.minecraftforge.fml", true);
        this.addMixinRule("net.minecraftforge.fml.client.gui.screen", true);
        this.addMixinRule("net.minecraftforge.fml.network", true);
