...
public class RedirectionorMixinConfig {
    ...
    public RedirectionorMixinConfig() {
        ...
        this.addMixinRule("client.gui.screens.worldselection", true);
        ...
        this.addMixinRule("client.tutorial", true);
        this.addMixinRule("commands.arguments.selector.options", true);
        this.addMixinRule("compat", true);
        this.addMixinRule("compat.lithium", isNotLoaded("lithium") && isNotLoaded("canary") && isNotLoaded("roadrunner") && isNotLoaded("radium"));
        this.addMixinRule("compat.modernfix", isNotLoaded("modernfix"));
        this.addMixinRule("compat.nicerportals", isNotLoaded("nicerportals"));
        this.addMixinRule("compat.sodium", isNotLoaded("sodium") && isNotLoaded("magnesium") && isNotLoaded("chlorine") && isNotLoaded("rubidium"));
        this.addMixinRule("data.model", true);
        this.addMixinRule("network", true);
        this.addMixinRule("network.chat", true);
